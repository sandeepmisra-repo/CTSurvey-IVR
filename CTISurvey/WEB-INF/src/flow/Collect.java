 ...
 * Last generated by Orchestration Designer at: 2019-AUG-08  11:57:30 AM
 */
public class Collect extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("NoInput", false);
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("SurveyAnn", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("SurveyDTMF", "1.0"));


		// build events for the field: "Collect"
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("Store", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("Collect", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Store");
		return submit;
	}
	/**
