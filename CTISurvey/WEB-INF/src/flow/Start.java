 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2019-AUG-08  11:33:06 AM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("LogFileIn");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SURVEY_DTMFDATA, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.COLLECT_FIELD_CONFIDENCE,
			IProjectVariables.COLLECT_FIELD_INPUTMODE,
			IProjectVariables.COLLECT_FIELD_INTERPRETATION,
			IProjectVariables.COLLECT_FIELD_NOINPUTCOUNT,
			IProjectVariables.COLLECT_FIELD_NOMATCHCOUNT,
			IProjectVariables.COLLECT_FIELD_UTTERANCE,
			IProjectVariables.COLLECT_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.COLLECT, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.GET_INPUT, "", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.COLLECT_ANN, "", null, session, false, false );
		session.putVariable(variable);
