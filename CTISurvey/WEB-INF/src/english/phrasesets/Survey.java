 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-AUG-08  11:54:46 AM
 */
public class Survey extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: Survey
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Survey", "Survey.wav", ""); 

		// phrase: Demo
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Demo", "Surveys.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Survey.PHRASE_MAP, phraseName));
	}
}
